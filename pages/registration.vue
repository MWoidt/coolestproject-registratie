    ...
    <b-col>
      ...
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <b-form-group id="input-group-2" label="Voornaam:" label-for="input-3">
          <b-form-input id="input-3" v-model="form.name" required placeholder="Geef je voornaam in"></b-form-input>
        </b-form-group>

        <b-form-group id="input-group-3" label="Achternaam:" label-for="input-4">
          <b-form-input id="input-4" v-model="form.name" required placeholder="Geef je achternaam in"></b-form-input>
        </b-form-group>

        <b-form-group id="input-group-3" label="Geslacht:" label-for="input-3">
          <b-form-select id="input-3" v-model="form.sex" :options="geslacht" required></b-form-select>
        </b-form-group>

        <b-form-group id="input-group-3" label="T-shirt type:" label-for="input-3">
          <b-form-select id="input-3" v-model="form.shirttype" :options="shirttype" required></b-form-select>
        </b-form-group>

        <b-form-group id="input-group-3" label="T-shirt maat:" label-for="input-3">
          <b-form-select id="input-3" v-model="form.size" :options="shirtsize" required></b-form-select>
        </b-form-group>

        <b-form-group id="input-group-3" label="Van waar ken je ons:" label-for="input-3">
          <b-form-input id="input-4" v-model="form.via" placeholder="Geef je dojo, school, ..."></b-form-input>
        </b-form-group>
        ...
        <div v-show="!isGuardianNeeded">
          <b-form-group id="input-group-3" label="Zijn er aandoeningen of allergieën waar we rekening mee moeten houden:" label-for="input-3">
            <b-form-textarea id="input-4" v-model="form.medical"></b-form-textarea>
          </b-form-group>

          <b-form-group id="input-group-4">
            <b-form-checkbox-group v-model="form.questions" id="checkboxes-4">
            <b-form-checkbox value="photo">Ik ben akkoord dat er fotos genomen worden</b-form-checkbox>
            <b-form-checkbox value="contact">Je mag me contacteren voor de volgende events</b-form-checkbox>
        ...
        >
         ...
         <b-form-group id="input-group-3" label="Is er nog extra informatie waar we rekening mee moeten houden:" label-for="input-3">
            <b-form-textarea id="input-4" v-model="form.extra"></b-form-textarea>
         </b-form-group>
        ...
        <h1>Project</h1>
        <b-form-group label="">
          <b-form-radio v-model="own_project" name="own_project" value="own">Ik heb mijn eigen project</b-form-radio>
          <b-form-radio v-model="own_project" name="own_project" value="other">Ik werk mee aan een bestaand project</b-form-radio>
        </b-form-group>
        <div v-if="isOwnProject">
          <b-form-group id="input-group-3" label="Taal:" label-for="input-4" description="In welke taal wil je het project uitleggen aan de jury">
            <b-form-select v-model="form.project_lang" :options="languages"></b-form-select>
          </b-form-group>
          <b-form-group id="input-group-3" label="Projecttype:" label-for="input-4" description="Selecteer wat je project allemaal doet, nodig heeft">
            <b-form-select v-model="form.project_type" :options="project_types" multiple></b-form-select>
          </b-form-group>
          <b-form-group id="input-group-3" label="Projectnaam:" label-for="input-4">
            <b-form-input id="input-4" v-model="form.project_name" required placeholder="Projectnaam"></b-form-input>
          </b-form-group>
          <b-form-group id="input-group-3" label="Omschrijving:" label-for="input-3">
              <b-form-textarea id="input-4" v-model="form.project_descr"></b-form-textarea>
          </b-form-group>
        </div>
        <div v-else>
          <b-form-group id="input-group-3" label="Projectcode:" label-for="input-4" description="Geef de code in die je van de projecteigenaar gekregen hebt">
            <b-form-input id="input-4" v-model="form.project_code" required placeholder="Code"></b-form-input>
          </b-form-group>
        </div>
        <b-form-group>
          <b-form-checkbox value="ok">Ik ben akkoord met de algemene voorwaarden</b-form-checkbox>
        </b-form-group>
        <b-form-group>
          <b-button type="submit" variant="primary">Ik schrijf me in</b-button>
          <b-button type="reset" variant="danger">Verwijder alles</b-button>
        </b-form-group>
      </b-form>
    </b-col>
  </b-row>
